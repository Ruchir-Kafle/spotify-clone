...
<main class="min-h-screen bg-zinc-950 text-zinc-100">
	<div class="grid min-h-screen grid-cols-1 lg:grid-cols-[248px_minmax(0,1fr)]">
		...
		<section class="flex min-h-screen min-w-0 flex-col pb-24">
			...
			<div class="min-h-0 flex-1 px-5 py-5 sm:px-8">
				<div class="mb-3 flex items-center justify-between gap-4 text-sm text-zinc-400">
					...
					<div class="hidden sm:block">Metadata only. Playback arrives later.</div>
				</div>
							...
							<div class="relative" style={`height: ${totalHeight}px;`}>
								...
								>
									{#each visibleSongs as song, index (song.id)}
										<div
											class="grid h-[60px] grid-cols-[52px_minmax(220px,2fr)_minmax(150px,1fr)_minmax(150px,1fr)_86px_72px] items-center border-b border-zinc-900 px-3 text-sm hover:bg-zinc-900/80"
										>
											<div class="text-zinc-500">{startIndex + index + 1}</div>
											<div class="min-w-0">
